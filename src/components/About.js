    ...
    return (
      <div className="About section about-section">
        <h1 className="about-intro">
          <strong>Matthew Gerard Thorry</strong>: Not your average coder
        </h1>
        ...
        <p className="about-item">
          ...
          </a>. I always had a strong desire to understand how the world worked
          ...
          <strong>taught science</strong> for seven years to students in grades
          8 - 12. Students generally agreed that my class was{" "}
        ...
        <p className="about-item">
          ...
          </strong>but I'm looking forward to finding a role where I can help
          build real products that people love.{" "}
          <a
